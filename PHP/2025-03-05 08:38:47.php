            ...
            <div class="tuli_box">
                <div class="tuli" id="project_amount2" _echarts_instance_="ec_1740042444884" style="-webkit-tap-highlight-color: transparent; user-select: none; position: relative;">
                    ...
                    <div style="position: absolute; display: none; border-style: solid; white-space: nowrap; z-index: 9999999; transition: left 0.4s cubic-bezier(0.23, 1, 0.32, 1), top 0.4s cubic-bezier(0.23, 1, 0.32, 1); background-color: rgba(50, 50, 50, 0.7); border-width: 0px; border-color: rgb(51, 51, 51); border-radius: 4px; color: rgb(255, 255, 255); font: 14px / 21px sans-serif; padding: 5px; left: 486px; top: 148px; pointer-events: none;">2017 Q1
                        <br><span style="display:inline-block;margin-right:5px;border-radius:10px;width:10px;height:10px;background-color:#06ACBC;"></span>生命健康: 0.00
                        
                        <br><span style="display:inline-block;margin-right:5px;border-radius:10px;width:10px;height:10px;background-color:#51638B;"></span>环境健康: 0.00
                        <br><span style="display:inline-block;margin-right:5px;border-radius:10px;width:10px;height:10px;background-color:#15CDAC;"></span>金融投资: 0.00
                        <br><span style="display:inline-block;margin-right:5px;border-radius:10px;width:10px;height:10px;background-color:#92E88A;"></span>低碳消费: 0.00
                        
                        <br><span style="display:inline-block;margin-right:5px;border-radius:10px;width:10px;height:10px;background-color:#F0DD98;"></span>城市更新: 0.00
    ...
    <div class="table-container">
        <table class="datatables layui-table dataTable">
            <thead>
                ...
                <tr role="row">
                    <th class="fixed-column">五大业务板块</th>
                    <th>新增拟投资金额（万元）</th>
                    <th>新增项目数量</th>
                    <th>新增拟投资金额（万元）</th>
                    <th>新增项目数量</th>
            ...
            <tbody>
                <tr class="row-weight">
                    <td class="fixed-column" rowspan="2" style="text-align: center !important;">生命健康</td>
                    <td>10,000.00</td>
                    <td>3.00</td>
                    <td>28,000.00</td>
                    <td>2.00</td>
                ...
                <tr class="row-weight">
                    <td class="fixed-column" rowspan="2" style="text-align: center !important;">环境健康</td>
                    <td>11,300.00</td>
                    <td>5.00</td>
                    <td>7,750.00</td>
                    <td>2.00</td>
                ...
                <tr class="row-weight">
                    <td class="fixed-column" rowspan="2" style="text-align: center !important;">金融投资</td>
                    <td>14,000.00</td>
                    <td>2.00</td>
                    <td>40,300.00</td>
                    <td>4.00</td>
                ...
                <tr class="row-weight">
                    <td class="fixed-column" rowspan="2" style="text-align: center !important;">低碳消费</td>
                    <td>24,000.00</td>
                    <td>4.00</td>
                    <td>17,900.00</td>
                    <td>3.00</td>
                ...
                <tr class="row-weight">
                    <td class="fixed-column" rowspan="2" style="text-align: center !important;">城市更新</td>
                    <td>8,800.00</td>
                    <td>3.00</td>
                    <td>6,500.00</td>
                    <td>2.00</td>
...
<script>
        var data = {
            ...
            legend: ["生命健康", "环境健康", "金融投资", "低碳消费", "城市更新"],
